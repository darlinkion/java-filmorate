...
(
    ...
    CONSTRAINT FK_FILM_ID_LIKES FOREIGN KEY (FILM_ID) REFERENCES FILM(FILM_ID) ON DELETE CASCADE,
...
(
    ...
    USER_ID     INTEGER NOT NULL,
    FILM_ID     INTEGER NOT NULL,
    USERFUL     INTEGER NOT NULL,
    CONSTRAINT REVIEW_ID_PK PRIMARY KEY (REVIEW_ID),
    CONSTRAINT REVIEWS_FILM_ID FOREIGN KEY (FILM_ID) REFERENCES FILM (FILM_ID),
...
(
    ...
    CONSTRAINT GRADE_REVIEW_USER_ID FOREIGN KEY (USER_ID) REFERENCES USERS (ID),
    CONSTRAINT GRADE_REVIEW_REVIEW_ID FOREIGN KEY (REVIEW_ID) REFERENCES REVIEWS (REVIEW_ID)
);
